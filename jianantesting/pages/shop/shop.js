Page({
  ...
  introduction: function (e) {
    ...
    wx.request({
      ...
      complete: function (){
        var content = '游戏名称：' + that.data.currentgame.name + '； 游戏人数：' + that.data.currentgame.playernumber + '； 男性人数下限：' + that.data.currentgame.malenumber + '； 女性人数下限：' + that.data.currentgame.femalenumber + '； 游戏简介：' + that.data.currentgame.descripion
        wx.showModal({
          title: '详细介绍',
          content: content,
          confirmText:'创建',
